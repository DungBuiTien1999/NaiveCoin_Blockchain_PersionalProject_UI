<template>
  <div>
    ...
    <div class="transaction" v-for="tx in transactionPool" :key="tx.id">
      <div class="row">
        <span >TxId: {{ tx.id }}</span>
      </div>
      <div class="row">
        <div class="five columns">
          <div v-for="txIn in tx.txIns" :key="txIn.signature">
        ...
        <div class="six columns">
          <div class="row" v-for="txOut in tx.txOuts" :key="txOut.address">
